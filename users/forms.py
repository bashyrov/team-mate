    ...
    class Meta:
        ...
        widgets = {
            ...
            "portfolio_url": forms.URLInput(
                attrs={"class": "form-control", "placeholder": "Portfolio URL"}
            ),
            ...
            "behance_url": forms.URLInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Behance profile URL",
                }
            ),
            "telegram_contact": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Telegram username or link",
                }
            ),
            "discord_contact": forms.TextInput(
                attrs={
                    "class": "form-control",
