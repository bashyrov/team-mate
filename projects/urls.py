...
urlpatterns = [
    ...
    path('project/<int:project_pk>/rate/', views.ProjectRatingCreateView.as_view(), name='project_rate'),
    ...
    path("projects/<int:project_pk>/applications/", views.ProjectApplicationListView.as_view(), name="applications_list"),
    path('projects/<int:project_pk>/applications/<int:pk>/approve/', views.application_approve, name='application_approve'),
