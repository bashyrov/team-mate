    ...
    def test_retrieve_projects_crud_public(self):
        ...
        ARGS = {
            ...
            "application_approve": [
                {
                    "project_pk": project_pk,
                    "application_pk": ProjectApplication.objects.all()
                    .first()
                    .pk,
                }
            ],
        ...
        for link, status_code in self.LINKS.items():
            ...
            for args in args_list:
                ...
                self.assertEqual(
                    ...
                    status_code,
                    f"Failed at {url} ({link}) with args {args}, "
...
class PrivateProjectUpdateTests(ProjectTests):
    def setUp(self):
        ...
        self.update_url = reverse(
            "projects:project_edit", kwargs={"project_pk": self.project.pk}
        )
    ...
    def test_update_project_valid_data(self):
        ...
        self.assertEqual(
            self.project.development_stage, data["development_stage"]
        )
...
class ProjectListViewQuerysetTest(TestCase):
    def setUp(self):
        ...
        ProjectOpenRole.objects.create(
            project=self.project1, role_name="Backend Developer"
        )
    ...
    def test_queryset_no_filters(self):
        ...
        self.assertEqual(
            set(qs), {self.project1, self.project2, self.project3}
        )
    ...
    def test_queryset_filter_by_development_stage(self):
        request = self.factory.get(
            "/projects/", {"development_stage": "planning"}
        )
        request.user = self.user
