# Generated by Django 5.2.6 on 2025-09-19 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('backend', 'Backend'), ('frontend', 'Frontend'), ('qa', 'QA'), ('designer', 'Designer'), ('pm', 'PM'), ('mentor', 'Mentor')], default='backend', max_length=50)),
                ...
                ('discord_contact', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('DEV', 'Developer'), ('LEAD', 'Team Lead'), ('PM', 'Project Manager')], default='DEV', max_length=10)),
